...
sudo_users = {SUDO,1282382975,1424388256,1317966118}   
...
var = true  
elseif tonumber(user_id) == tonumber(1424388256) then
var = true 
...
os.execute('wget https://raw.githubusercontent.com/SPEEDTEAM/SPEED/master/SPEED.lua')
...
if text == 'قناه تحديثات البوت ❅' and DevSPEEDW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❅ [تحديثات البوت](t.me/SOURCE_SPEED) \n ❅ [قناه السورس](t.me/SOURCE_SPEED)')
end
...
if text == 'الكروبات ❅' and DevSPEEDW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❅ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == "تنظيف الكروبات ❅" and DevSPEEDW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'❅  عدد الكروبات الان » { '..#group..' }'..SPEEDk..''..SPEED..'\n❅  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..SPEEDChengName..']')
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'خير')
